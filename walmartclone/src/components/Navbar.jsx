      ...
      >
        ...
        >
          <Box display="flex" alignItems="center" justifyContent="space-evenly">
            {drawerState ? (
              <RxHamburgerMenu onClick={() => { setDrawerState((prev) => !prev); onOpen(); }} />
            ) : (
              <RxHamburgerMenu onClick={() => { setDrawerState((prev) => !prev); onClose(); }} />
            )}
            <SideNavbar isOpen={isOpen} onOpen={onOpen} onClose={onClose} />
            <Image src="https://i5.walmartimages.com/dfw/4ff9c6c9-d10e/k2-_ef2c8660-96ed-4f64-891d-329fa488c482.v1.png" w="30%" m={4} />
          </Box>
        </Box>
        ...
        <Box w={{ base: "100%", sm: "100%", md: "100%", lg: "50%", xl: "50%" }} className="walmartinput">
          <InputGroup size="md" bg="#FFFFFF" borderRadius="20px" className="search-bar">
            <Input
              pr="4.5rem"
        ...
        >
          <Box display="flex" alignItems="center" p={3} className="items">
            <Box>
              <CiHeart />
            </Box>
            <Box ml={2}>
        ...
        >
          <Box display="flex" alignItems="center" p={3} className="account">
            <Menu>
              <MenuButton
                px={4}
                py={2}
              ...
              >
                <Box display="flex" alignItems="center" className="account">
                  <Box>
                    <BiUser />
                  </Box>
                  <Box ml={2} className="acc">
                    <Text className="roboto-regular" color="#ccc" fontSize="12px">
              ...
              <MenuList p={10}>
                ...
                <Text mt={5} color="black">
                  {auth ? (
                    <Box display="flex" alignItems="center" cursor="pointer" onClick={signOut}>
                      <IoIosLogOut />
        ...
        <Box className="cart" color="white">
          <Box display="flex" alignItems="center" p={3} className="cart">
            <Box>
              <ChakraLink
                as={ReactRouterLink}
                to="/home/cart"
